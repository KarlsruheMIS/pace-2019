...
In addition to the 100 public instances, the PACE Implementation Challenge tests all submissions on 100 private instances. Detailed results for those instances can be found in~\cite{PACETR}. The results are similar to the results on the private instances. %, which are not yet available for additional experiments.
